...
namespace rotator_Policy
{
	public class rotator_Policy : Entity
	{
		// Match this to the PolicySlot.Id you see for 'rotator' in the RobotControllerComponent inspector.
		private const uint k_SlotId = 2;
